...
import AiControl, { Props as AiControlProps } from './ai-control';
...
const ObserveAiControl = ControlVisibilityObserver<AiControlProps>(AiControl);
    ...
    return (
        <Layout.Sider className='cvat-canvas-controls-sidebar' theme='light' width={44}>
            ...
            <ObserveAiControl
                canvasInstance={canvasInstance}
                disabled={controlsDisabled}
                isDrawing={activeControl === ActiveControl.AI_TOOLS}
            />
